...
/**
 * Returns a state from the given props
 * @param {arrayOf category} categories the categories of skills
 * @param {arrayOf skill} skills the skills to initialize
 * @const
 */
...
/**
 * A class for representing skills data
 * Can selectively display requested skills by category
 * @class @export
 */
class Skills extends Component {
  ...
  getRows() {
    ...
    return this.state.skills.sort((a, b) => {
      if (!a.compentency || !b.compentency) { return 0; }
      let ret = 0;
